...
public class CatégorieFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        catégorieViewModel =
                new ViewModelProvider(this).get(CatégorieViewModel.class);

        binding = FragmentCategorieBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        final TextView textView = binding.textCategorie;
        catégorieViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
